	...
	var init = function( hash ){
		...
		Util.loadImg( function(){	
			...
			Util.loadAudio( function(){
				...
				div.innerHTML = 'SPH Fighter by Kevin Speranza <br> ---- Press 1 for Single Player ---- <br> ----- Press 2 for Multiplayer ----- <br> <br> '
				...
				div.style.color = 'yellow';
				div.style.zIndex = 9999;
				div.innerHTML = 'Player 1 Controls: <br> <br> Movement: <br> Jump = W <br> Move-Back = A <br> Crouch = S <br> Move-Forward (fwd) = D <br> <br> Attacks: <br> Light Punch (LP) = G <br> Heavy Punch (HP) = H <br> Light Kick = T <br> Heavy Kick = Y <br> <br> Special Attacks: <br> Teleport1 = back-crouch-fwd-LP<br>Teleport2 = fwd-back-fwd-crouch-LP<br> Energy Blast = back-fwd-LP/HP<br><br>Hold *Back* to block'
				document.body.appendChild( div );
				...
				div.style.height = '32px';
				div.style.top = '5px';
				div.style.left = '920px';
				div.style.position = 'absolute';
				div.style.color = 'yellow';
				div.style.zIndex = 9999;
				div.innerHTML = 'Player 2 Controls: <br> <br> Movement: <br> Jump = Up-Arrow <br> Move-Back = Left-Arrow <br> Crouch = Down-Arrow <br> Move-Forward (fwd) = Right-Arrow <br> <br> Attacks: <br> Light Punch (LP) = M <br> Heavy Punch (HP) = ,/< <br> Light Kick (LK) = J <br> Heavy Kick (HK) = K <br> <br> Special Attacks: <br> Energy Blast = crouch-fwd-LP/HP<br>Whirl Kick = crouch-back-LK/HK<br> Uppercut = fwd-crouch-fwd-LP/HP <br><br> Hold *Back* to block'
				document.body.appendChild( div );
...
var gameStart = function(){
		...
		player1.init( 180, 180, 1 );   //left, top, direction
	
		player2.init( 580, 240, -1 );  //left, top, direction
...
var Blood = function(){
	...
	var leftBar = function(){
		...
		var _blood = 1500, _f_left = 100, _f__blood = 1500, _f_width = 322, currWidth = _f_width, timer, animate, emptyfn;
	...
	var rightBar = function(){
		...
		var _blood = 1500, _f_left = 493, _f__blood = 1500, _f_width = 319, currWidth = _f_width, timer, animate, emptyfn, queue = Interfaces.Queue();
...
Game.reload = function(){
	...
	setTimeout( function(){
		...
		setTimeout( function(){
		 player1.animate.moveto( 180, 180 );
		...
		setTimeout( function(){
		 player2.animate.moveto( 580, 240 );
